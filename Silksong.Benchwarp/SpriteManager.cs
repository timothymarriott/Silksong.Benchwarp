...
namespace Benchwarp
{
    ...
    {
        private const string _prefix = "Silksong.Benchwarp.Resources.Styles.";
        ...
        public static Sprite GetSprite(string name)
        {
            ...
            {
                Benchwarp.log.LogError($"{name} does not correspond to any embedded resource under {_prefix}");
                return null;
            }
