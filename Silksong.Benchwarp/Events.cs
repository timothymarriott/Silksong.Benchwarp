...
namespace Benchwarp
{
    public static class Events
    {
        ...
        internal static void InvokeOnBenchSelected()
        {
            ...
            catch (Exception e) { Benchwarp.log.LogError(e); }
        }
        ...
        {
            string name = Localization.Localize(bench.name);
        ...
        {
            string name = Localization.Localize(bench.areaName);
        ...
        public static string GetSceneName(string sceneName) => Localization.Localize(OnGetSceneName.Invoke(sceneName));
