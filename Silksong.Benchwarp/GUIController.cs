...
namespace Benchwarp
{
    public class GUIController : MonoBehaviour
    {
        ...
        private void LoadResources()
        {
            ...
            {
                Benchwarp.log.LogWarning("Unable to find Arial! Using Perpetua.");
            ...
            {
                Benchwarp.log.LogError("Could not find game fonts");
            }
            ...
            {
                if (!res.StartsWith("Silksong.Benchwarp.Resources.Images.")) continue;
                ...
                {
                    Benchwarp.log.LogError("Failed to load image: " + res + "\n" + e);
                }
            }
        }
        ...
        public static GUIController Instance
        {
            get
            {
                ...
                Benchwarp.log.LogWarning("Couldn't find GUIController");
